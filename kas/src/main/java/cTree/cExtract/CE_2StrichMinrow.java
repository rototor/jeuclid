...
public class CE_2StrichMinrow extends CExtractBase {
    ...
    public CE_2StrichMinrow() {
        ...
        this.extracters.put(this.strArray[0], new CE_2StrichPunktVZM());
        this.extracters.put(this.strArray[1], new CE_2StrichPunkt1M());
        this.extracters.put(this.strArray[2], new CE_2StrichPunktLM());
    }
