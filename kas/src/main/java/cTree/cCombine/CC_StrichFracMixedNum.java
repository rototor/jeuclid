...
public class CC_StrichFracMixedNum extends CC_Base {
    ...
    protected CElement createNumberCombination(final CElement parent,
        ...
        final int gVal2 = ((CNum) this.cM.getWholeNumber()).getValue();
        final int zVal2 = ((CNum) this.cF.getZaehler()).getValue();
        final int nVal2 = ((CNum) this.cF.getNenner()).getValue();
