...
public class CCombiner1StrichMinrow extends CCombiner1 {
    ...
    public CElement combine(final CElement parent, final CElement cE1,
        ...
        if (this.canCombine(parent, cE1, cE2)) {
            ...
            if (this.cI.istGleichartigesMonom(cE2)) {
                ...
                return this.op2Combiner.get(cE2.getCType()).combine(parent,
                        cE1, cE2);
            } else if ((this.cI instanceof CNum)
                    || (this.cI instanceof CFrac)
                    || (this.cI instanceof CMixedNumber)) {
                final boolean replace = CombineHandler.getInstance().justTwo(
                        cE1, cE2);
                final CElement newEl = this.myCombiner.createCombination(
                        parent, this.cI, cE2);
                return CombineHandler.getInstance().insertOrReplace(parent,
                        newEl, cE1, cE2, replace);
            }
        }
        return cE1;
    }
    ...
    public boolean canCombine(final CElement parent, final CElement cE1,
        ...
        if (this.cI.istGleichartigesMonom(cE2)) {
            ...
            this.myCombiner = CombineHandler.getInstance().getCombiner(
                    parent, this.cI, cE2);
