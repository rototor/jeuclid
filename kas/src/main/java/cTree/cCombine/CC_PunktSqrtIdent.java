...
public class CC_PunktSqrtIdent extends CC_ {
	...
	protected CElement createCombination(CElement parent, CElement cE1, CElement cE2){
		...
		CPot cPot = CPot.createSquare(cE2);
		CElement cE22 = CSqrt.createSqrt(cPot);
		ArrayList<CElement> radList = CSqrt.getRadikandList(CSqrt.createRootList(cE1, cE22));
