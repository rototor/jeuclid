...
/* $Id: MathText.java,v 1.13.2.6 2007/01/31 22:50:26 maxberger Exp $ */
...
public class MathText extends AbstractMathElement {
    ...
    public void paint(Graphics g, int posX, int posY) {
        ...
        if (getText().length() > 0) {
            ...
            this.produceTextLayout(g2d).draw(g2d, posX, posY);
        }
    }
    ...
    public int calculateWidth(Graphics g) {
        if (getText().equals("")) {
            ...
            return (int) this.produceTextLayout((Graphics2D) g).getAdvance();
        }
    }
    ...
    public int calculateAscentHeight(Graphics g) {
        if (getText().equals("")) {
            ...
            return (int) this.produceTextLayout((Graphics2D) g).getAscent();
        }
    }
    ...
    public int calculateDescentHeight(Graphics g) {
        if (getText().equals("")) {
            ...
            return (int) this.produceTextLayout((Graphics2D) g).getDescent();
        }
    }
     ...
     */
    public static int getCharsMaxDescentHeight(Graphics g, final Font font,
            final char[] chars) {
        int result = 0;
     ...
     *            Graphics context to use.
     */
    public static int getCharsMaxAscentHeight(Graphics g, Font font,
            char[] chars) {
        int result = 0;
