...
public final class Mml2xxx {
    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            switch (files.length) {
                case 0: throw new ParseException("No source given");
                case 1: throw new ParseException("No target given");
                case 2: break;
                default: throw new ParseException("Too many non-option arguments");
            }
            ...
            if (outFileType == null) {
                ...
                if (dot == -1 || dot == fileName.length() - 1) {
                    throw new ParseException("no -" + Mml2xxx.OUT_FILE_TYPE 
                ...
                if (!ConverterRegistry.getRegisty().getAvailableOutfileTypes()
